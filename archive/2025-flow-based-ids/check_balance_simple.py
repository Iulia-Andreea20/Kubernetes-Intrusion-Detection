#!/usr/bin/env python3
"""
Memory-efficient balance check for large BCCC dataset
"""
...
def check_balance_chunked(data_path: str, chunk_size: int = 100000):
    ...
    # First pass: find label column and count
    print("First pass: Finding label column...")
    ...
    print(f"Second pass: Counting labels (processing in chunks of {chunk_size:,})...")
    ...
    # Determine which labels are benign
...
if __name__ == "__main__":
    ...
    try:
        check_balance_chunked(data_path, chunk_size)
