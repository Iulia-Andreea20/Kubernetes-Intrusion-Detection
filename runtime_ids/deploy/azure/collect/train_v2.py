...
DS="/Users/iulia-andreeagrigore/Projects/Kubernetes-Intrusion-Detection/runtime_ids/deploy/azure/collect/reference_dataset_v2/ref_v2_all.csv"
...
def ep_anom(rs,u):  # SUPORT: identitate allowlistata-prin-prefix DAR NECUNOSCUTA (SA fabricat in kube-system) -> aplica regulile de rata
    if not allowed(u): return False        # ne-allowlistat: deja acoperit de recon/destruct/hijack/persist
    if u in KNOWN_ALLOW: return False       # controller benign cunoscut -> exonerat (reziduu: controller existent compromis)
